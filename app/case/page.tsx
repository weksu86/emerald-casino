...
export default function CasePage() {
  ...
  function openCase() {
    ...
    setTimeout(() => {
      ...
      setMessage(
        `You won ${selectedWinner.name} — 💎 ${selectedWinner.value.toLocaleString(
          "en-US"
        )}`
      );
  ...
  return (
    <main className="min-h-screen bg-[#0B0B0F] text-[#F2F2F2]">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8">
        ...
        {/* CASE PRICE */}
        <div className="mx-auto mt-6 flex w-fit items-center gap-3 rounded-xl border border-[#6C2BD9]/40 bg-[#15131D] px-5 py-3">
        ...
        <div className="mx-auto mt-8 max-w-2xl rounded-2xl border border-[#F5C542]/20 bg-[#15131D] px-6 py-5 text-center">
          ...
          <p className="mt-2 text-xs leading-5 text-gray-500">
            Case openings use virtual Emeralds
            and demo items only. No real money,
            Steam items or external transfers are
            processed.
          </p>
        </div>
      </section>
      ...
      <style jsx>{`
        ...
        .win-glow {
          animation: glowExpand 1.5s ease-out
            both;
        }
